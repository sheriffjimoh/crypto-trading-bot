      ...
      {analyses?.map((analysis: any) => (
        <div key={analysis.id} className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
          <div className="p-4 border-b">
            <div className="flex justify-between items-center">
              <div>
                ...
                <span className="text-sm text-gray-500">Rank #{analysis.marketCapRank}</span>
              </div>
          ...
          <div className="p-4 space-y-4">
            ...
            {/* Market Analysis */}
            <div>
              <p className="text-sm text-gray-500 mb-2">Market Analysis</p>
            ...
            {/* Price Targets */}
            <div>
              <p className="text-sm text-gray-500 mb-2">Price Targets</p>
              <div className="grid grid-cols-2 gap-2">
                <div className="text-sm">
                  <span className="text-gray-500">Support: </span>
                  <span className="font-medium">${analysis.analysis.priceTarget.support}</span>
                </div>
                <div className="text-sm">
                  <span className="text-gray-500">Resistance: </span>
                  <span className="font-medium">${analysis.analysis.priceTarget.resistance}</span>
                </div>
              </div>
            </div>
            ...
            {/* Trends */}
            <div>
              <p className="text-sm text-gray-500 mb-2">Market Trends</p>
              <div className="grid grid-cols-2 gap-2">
            ...
            <div>
              ...
              <div className="space-y-1">
                ...
                <div className="text-sm">
                  <span className="text-gray-500">ATH Distance: </span>
                  <span className="font-medium">{analysis.keyMetrics.athDistance}%</span>
                </div>
              </div>
            </div>
